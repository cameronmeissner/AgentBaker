...
var _ = Describe("GetSIGAzureCloudSpecConfig", func() {
	...
	It("should return correct value", func() {
		...
		Expect(mariner.Version).To(Equal("000.000.000"))
		...
		Expect(aksUbuntu2204Containerd.Version).To(Equal("000.000.000"))
		...
		Expect(aksUbuntu2204Gen2Containerd.Version).To(Equal("000.000.000"))
		...
		Expect(aksUbuntu2004CVMGen2Containerd.Version).To(Equal("000.000.000"))
