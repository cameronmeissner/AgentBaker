...
var _ = Describe("GetSIGAzureCloudSpecConfig", func() {
	...
	It("should return correct value", func() {
		...
		Expect(aksUbuntuArm642204Gen2.Version).To(Equal(PrivateImageVersion))
		...
		Expect(aksUbuntu2204Containerd.Version).To(Equal(PrivateImageVersion))
		...
		Expect(aksUbuntu2204Gen2Containerd.Version).To(Equal(PrivateImageVersion))
		...
		Expect(aksUbuntu2004CVMGen2Containerd.Version).To(Equal(PrivateImageVersion))
		...
		Expect(aksUbuntu2204TLGen2Containerd.Version).To(Equal(PrivateImageVersion))
		...
		Expect(aksUbuntuEdgeZoneContainerd2204.Version).To(Equal(PrivateImageVersion))
		...
		Expect(aksUbuntuEdgeZoneContainerd2204Gen2.Version).To(Equal(PrivateImageVersion))
