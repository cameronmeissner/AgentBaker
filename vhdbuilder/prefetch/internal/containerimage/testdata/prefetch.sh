...
prefetch "mcr.microsoft.com/containernetworking/azure-cni:v1.5.37" "/dropgz"
...
prefetch "mcr.microsoft.com/containernetworking/azure-cns:v1.4.53" "/usr/local/bin/azure-cns"
